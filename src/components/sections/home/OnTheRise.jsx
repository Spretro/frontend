            ...
            {homeCategories.map((cat, i) => (
              <div key={i} className="shrink-0 cursor-pointer group fade-in-up" style={{ animationDelay: `${i * 0.07}s` }}>
                <div
                  ...
                  style={{ width: "clamp(170px, 17vw, 220px)", aspectRatio: "3/4", boxShadow: `0 4px 20px ${cat.accent}33` }}
                  onMouseEnter={(e) => (e.currentTarget.style.boxShadow = `0 16px 48px ${cat.accent}66`)}
                  onMouseLeave={(e) => (e.currentTarget.style.boxShadow = `0 4px 20px ${cat.accent}33`)}
                >
